          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-sm opacity-80 hover:opacity-100 transition-opacity">
                ...
                <a href="mailto:info@nexuschina.co.uk">info@nexuschina.co.uk</a>
              </div>
              <div className="flex items-center space-x-3 text-sm opacity-80 hover:opacity-100 transition-opacity">
              ...
              <div className="flex items-center space-x-3 text-sm opacity-80 hover:opacity-100 transition-opacity">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-champagne"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                <span>WeChat: aplanetUK</span>
              </div>
